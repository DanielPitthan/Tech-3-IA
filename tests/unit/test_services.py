...
class TestTriageService:
    ...
    def test_critical_by_keywords(self, service):
        ...
        level = service.classify(patient)
        assert level == TriageLevel.CRITICO
